...
*/
console.log(MenuElemaniOlustur('Tantuni', 60, 'Fast Food'));
console.log(MenuElemaniOlustur('Pizza', 160, 'Fast Food'));
console.log(MenuElemaniOlustur('Şırdan', 80, 'Pis yiyiciler için'));
